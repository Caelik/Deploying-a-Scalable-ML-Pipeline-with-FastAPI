...
project_path = "/home/bradk/Deploying-a-Scalable-ML-Pipeline-with-FastAPI"
...
for col in cat_features:
    ...
    for slice_value in sorted(test[col].unique()):
        ...
        p, r, fb = performance_on_categorical_slice(test, col, slice_value, cat_features, 'salary', encoder, lb, model)  
            # your code here
            # use test, col and slice_value as part of the input
